...
public class LoadUtil 
{
    ...
    public static LoadedObjectVertexNormalAverage loadFromFileVertexOnlyAverage(String fname, Resources r,Context context)
    {
    	//加载后物体的引用
    	...
    	try
    	{
		    ...
		    //创建3D物体对象
		    lo=new LoadedObjectVertexNormalAverage(context,vXYZ,nXYZ);
    	}
    	catch(Exception e)
    	{
    ...
    public static LoadedObjectVertexNormalFace loadFromFileVertexOnlyFace(String fname, Resources r,Context context)
    {
    	//加载后3D对象的引用
    	...
    	try
    	{
		    ...
		    //创建3D对象
		    lo=new LoadedObjectVertexNormalFace(context,vXYZ,nXYZ);
    	}
    	catch(Exception e)
    	{
    		Log.d("load error", "load error");
